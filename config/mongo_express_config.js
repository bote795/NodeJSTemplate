...
module.exports = {
  mongodb: {
    ...
    admin: !!configAuth.ME_CONFIG_MONGODB_ENABLE_ADMIN || false,
  ...
  site: {
    ...
    sessionSecret:    configAuth.mongoAdmin.secret                 || 'sessionsecret',
    sslCert:          configAuth.mongoAdmin.SSL_CRT_PATH           || '',
    sslEnabled:       configAuth.mongoAdmin.SSL_ENABLED            || false,
    sslKey:           configAuth.mongoAdmin.SSL_KEY_PATH           || '',
  },
